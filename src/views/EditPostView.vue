<template>
    ...
    <v-card class="bg-teal-lighten-5 pa-5 text-grey-darken-4">
        ...
        <QuillEditor toolbar="full" theme="snow" v-model:content="addPostInfo.description" placeholder="Enter content"
    ...
    <v-card class="ma-5 pa-5" v-for="post in posts" :key="post.id">
        ...
        <QuillEditor v-model:content="post.description" class="editor" theme="snow" toolbar="full" contentType="html" />
